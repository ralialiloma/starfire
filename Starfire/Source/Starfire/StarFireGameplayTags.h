			...
			namespace FP
			{
				...
				namespace AnimSequence
				{
					...
					namespace Sprint
					{
						STARFIRE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Name);
						STARFIRE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Start);
						STARFIRE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Loop);
						STARFIRE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(End);
					}
					STARFIRE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Idle);
					STARFIRE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Jump);
		...
		namespace Messages
		{
			...
			namespace Resources
			{
				...
				namespace Grenade
				{
					STARFIRE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Name);
					STARFIRE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Craft);
					STARFIRE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(MissPillar);
					STARFIRE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(HitPillar);
				}
			}
			namespace FP
			{
				...
				namespace Health
				{
					STARFIRE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Name);
					STARFIRE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Low);
					STARFIRE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TakeDamage);
			...
			namespace Game
			{
				...
				STARFIRE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(CloseToWin);
				STARFIRE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Lose);
				STARFIRE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(CloseToLose);
				namespace Cutscenes
				{
					STARFIRE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Name);
				}
