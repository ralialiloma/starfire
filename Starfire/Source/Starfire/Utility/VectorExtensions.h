...
#include "DaVinci/Utility/HelperFunctionLibrary.h"
#include "DaVinci/Utility/StructLibrary/GlobalDirection.h"
...
static FVector AsFVec(const FVector2f& Vector2, const float Z)
{
